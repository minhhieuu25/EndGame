...
const Experience = ({ handleInput, values }) => {
  return (
          ...
          <form>
            <div className="row mb-3">
              ...
              <div className="col-sm-8">
                <input type="text" className="form-control" onChange={handleInput} defaultValue={values.nameCompany} name='nameCompany' placeholder="Ex: FPT Software" />
              </div>
            </div>
            <div className="row mb-3">
              <label for="" className="col-sm-3 col-form-label">Position</label>
              <div className="col-sm-8">
                <input type="email" className="form-control" onChange={handleInput} defaultValue={values.positonCompany} name='positonCompany' placeholder="Ex: Ceo" />
              </div>
            </div>
            <div className="row mb-3">
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-8">
                <textarea className="form-control" onChange={handleInput} defaultValue={values.descriptionExperience} name='descriptionExperience' placeholder="Description"></textarea>
              </div>
            </div>
          </form>
          <hr />
